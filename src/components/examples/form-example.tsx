...
const formSchema = type({
  ...
  themeColor: type('string >= 1').narrow(
    (s, ctx) => hexColorRegex.test(s) || ctx.mustBe('a valid hex color (e.g., #6366f1 or #63f)'),
  ),
  framework: "'Next.js' | 'SvelteKit' | 'Nuxt.js' | 'Remix' | 'Astro'",
  comments: 'string',
})
